...
\TitreProjet{Enforcing Best Practices through LLM Integrations in Google´s internal IDE}

\AuteurA{Arij} {KOUKI} 
\HostedBy{\includegraphics[width=0.35\textwidth]{Images/google_logo.png}}
...
\part{Project Foundation and Methodology}
